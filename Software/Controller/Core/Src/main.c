...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(TE_SLEEP_GPIO_Port, TE_SLEEP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, TEMP2_Pin|TEMP1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_CS_Pin|LCD_RST_Pin|LCD_RS_Pin|FAN_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : TE_SLEEP_Pin */
  GPIO_InitStruct.Pin = TE_SLEEP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TE_SLEEP_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : TEMP2_Pin TEMP1_Pin */
  ...
  /*Configure GPIO pins : LCD_RST_Pin FAN_EN_Pin */
  GPIO_InitStruct.Pin = LCD_RST_Pin|FAN_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
